    ...
    <div className="pb-10 pt-2">
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-[28px] p-6 mb-8 flex items-center gap-5">
        {user?.user_metadata?.avatar_url ? (
          <img src={user.user_metadata.avatar_url} alt="" className="w-16 h-16 rounded-[20px] object-cover ring-4 ring-white/5" />
        ) : (
          <div className="w-16 h-16 rounded-[20px] bg-brand-600/30 flex items-center justify-center text-brand-400 font-bold text-xl ring-4 ring-white/5">
      ...
      <div className="mb-8">
        ...
        <div className="flex gap-3 mt-4">
          <Link href="/room/create" className="flex-1 flex items-center justify-center gap-2 py-3.5 bg-brand-600/20 hover:bg-brand-600/30 text-brand-400 rounded-xl font-semibold transition-colors">
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
            </svg>
            Create
          </Link>
          <Link href="/room/join" className="flex-1 flex items-center justify-center gap-2 py-3.5 bg-white/5 hover:bg-white/10 text-white rounded-xl font-semibold transition-colors border border-white/5">
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
