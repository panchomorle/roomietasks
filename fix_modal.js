        ...
        {lbLoading || membersLoading ? (
          ...
          <div className="space-y-6">
            <div className="bg-white/5 rounded-2xl p-4">
              <h3 className="text-sm font-semibold text-slate-300 mb-3">Season Summary</h3>
              <div className="grid grid-cols-3 gap-2 text-center">
                <div className="bg-white/5 rounded-xl p-2">
                  <p className="text-[10px] text-slate-400 uppercase tracking-wider mb-1">Tasks Done</p>
                  <p className="text-lg font-bold text-white">{totalTasks}</p>
                </div>
                <div className="bg-white/5 rounded-xl p-2">
                  <p className="text-[10px] text-slate-400 uppercase tracking-wider mb-1">Total Pts</p>
                  <p className="text-lg font-bold text-white">{totalPoints}</p>
                </div>
                <div className="bg-white/5 rounded-xl p-2">
                  <p className="text-[10px] text-slate-400 uppercase tracking-wider mb-1">Total Pool</p>
            ...
            {leaderboard && leaderboard.length > 0 ? (
              ...
              <div className="bg-gradient-to-br from-brand-500/10 to-violet-500/10 border border-brand-500/20 rounded-2xl p-4 text-center">
                <p className="text-slate-400 font-medium">No tasks completed this season.</p>
              </div>
            )}
            ...
            >
              {endPeriod.isPending ? "Ending Season..." : "Confirm & End Season"}
            </button>
          </div>
        )}
      </div>
